...
class EditProfilePage extends StatelessWidget {
  ...
  })  : eduController = TextEditingController(text: education),
        expController = TextEditingController(text: experience),
        qualController = TextEditingController(text: qualifications),
        projController = TextEditingController(text: projects),
        super(key: key);
  @override
